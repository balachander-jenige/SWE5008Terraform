...
# ---------------------------------------------------------------------------
# Stage - auto_deploy = true means changes deploy immediately; no separate
# aws_api_gateway_deployment resource is needed.
# ---------------------------------------------------------------------------
...
resource "aws_security_group" "backend_sg" {
  ...
  # Allow inbound HTTP from the ALB only - no CIDR-based rule, SG reference only
  ingress {
